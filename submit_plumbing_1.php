...
<head>
    ...
    <style>
        body{
            background-image: url('https://cdn2.vectorstock.com/i/1000x1000/05/71/plumber-workers-pipes-plumbing-and-repair-service-vector-31100571.jpg');
...
<body>
    <div id="carpentry_form" >
        <form action="submit_plumbing.php" id="carpentry_form_1" method="POST">
            <h2>Apply Now...</h2>
            <div id="part1">
            ...
            <div id="block_address">
                ...
                <div id="flat_address" >
                    <input type="number" style="width:200px;height:50px;" placeholder="Enter the flat number" min="101" max="110" name="flat_number" required>
                </div>
            </div>
            <hr>
            <div id="part1">
                <span class="input-icon"><i class="far fa-id-card"></i></span>
                <input type="text" placeholder="Enter your mobile number" required pattern="[0-9]{10}" id="name_field" name="mobile_number">
            </div>
            <br>
            <br>
