...
<head>
    ...
    <style>
        body{
            background-image: url('https://cdn5.vectorstock.com/i/1000x1000/06/49/carpenter-joiner-workers-carpentry-woodworking-vector-31100649.jpg');
...
<body>
    <div id="carpentry_form" >
        <form action="submit_carpentry.php" id="carpentry_form_1" method="POST">
            <h2>Apply Now...</h2>
            <div id="part1">
            ...
            <div id="block_address">
                    <label for="">A:</label>
                    <input type="radio" value="A" name="select1" required>
                    <label for="">B:</label>
                    <input type="radio" value="B" name="select1" required>
                    <label for="">C:</label>
                    <input type="radio" value="C" name="select1" required>
                    <label for="">D:</label>
                    <input type="radio" value="D" name="select1" required>
                </div>
                <div id="flat_address" >
                    <input type="number" name="flat_number" style="width:200px;height:50px;" placeholder="Enter the flat number" min="101" max="110" value="101">
                </div>
            </div>
            <hr>
            <div id="part1">
            ...
            <div id="Payment">
                <input type="radio" value='offline' name="payment" id="a_a" required>Offline
                <br>
                <input type="radio" value='online' name="payment" id="a_b" required>Online
