...
$sql="Insert into plumbing_table (name,email,SELECT1,flat_number,mobile_number,payment) values ('$customer_name','$customer_email','$block','$flat_number','$mobile_number','$payment')";
$result=mysqli_query($conn,$sql);
if(!$result){
    echo "Error: ".mysqli_error($conn);
    exit;
...
<script type="text/javascript">
	...
	Email.send({
		...
		Subject: "CEEP Services-Plumbing Registration",
