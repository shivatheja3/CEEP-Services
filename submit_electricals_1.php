...
<head>
    ...
    <style>
        body{
            background-image: url('https://cdn2.vectorstock.com/i/1000x1000/76/06/home-electrical-service-electrician-workers-vector-30917606.jpg');
...
<body>
    <div id="carpentry_form" >
        <form action="submit_electricals.php" id="carpentry_form_1" method="POST">
            <h2>Apply Now...</h2>
            <div id="part1">
            ...
            <div id="block_address">
                ...
                <div id="flat_address" >
                    <input type="number" style="width:200px;height:50px;" placeholder="Enter the flat number" min="101" max="110" name="flat_number">
                </div>
            </div>
            <hr>
            <div id="part1">
