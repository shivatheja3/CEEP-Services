...
<body>
    ...
    <div id="worker">
        ...
        <br><br>
        <a href="http://localhost/sem3MiniProject/fetch_data_into_admin_of_workers.php" id="but3">Check it now</a>
    </div>
    <div id="reg">
        <h2>Registrations</h2>
        ...
        <br>
        <br>
        <a id="but1" href="http://localhost/sem3MiniProject/fetch_data_into_admin_by_unemployed.php">
            Check it now
        </a>
    </div>
    <div id="cus">
    ...
    <div><a href="fetch_from_work_assignments.php"><button id="check">Check the status of work assignments</button></a></div>
</body>
</html>
